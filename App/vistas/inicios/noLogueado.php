...
<link href="../Tienda/style.css" rel="stylesheet" type="text/css" />
    ...
    <div class="row">
        <div class="col-6 col-md-6 col-sm-6 col-12">
            ...
            <button class="btn btn-primary" disabled> Registrarse Primero!</button>
        </div>
        <div class="col-6 col-md-6 col-sm-6 col-12">
            <h3>Tienda</h3>
            ...
            <button class="button btn-primary"><i class="bi bi-hand-index-thumb"></i> &nbsp;<a href="<?php echo RUTA_URL ?>/login/Tienda" style="color:white"></i>Acceder a la tienda</a></button>
        </div>
    </div>
