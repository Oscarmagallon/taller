...
<div class="container">
        <div class="row">
            ...
            <div class="n"><p>    <b><font color="#000000" face="georgia" size="4"    </font></b></p><center>
    	...
    	<section id="about" >
            <div class="container">
              <div class="row">                
                ...
                <div class="card " style="width: 18rem;"> 
                  <div class="card-body">
                    <h1>Numero de peticiones disponibles</h1>
                    <div class="card-text">
              ...
              <div class="col-sm-12 col-md-6 col-lg-6 content wow fadeInRight">
                        <div class="card " style="width: 18rem;"> 
                          <div class="card-body">
                            <h1>Numero de mecanicos registrados</h1>
                              <div class="card-text">
            ...
            <!-- Fila 2-->
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 content wow fadeInRight"  data-wow-delay="0s"  data-wow-duration="1.9s">                
                  <div class="card " style="width: 18rem;"> 
                            <div class="card-body">
                              <h3>Numero clientes registrados</h3>
                                <div class="card-text">
