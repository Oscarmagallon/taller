                ...
                <?php if (!empty($datos['articulos'])) :
                    foreach ($datos['articulos'] as $e) : ?>
                        <tr>
                            ...
                            <td><?php if($e->reservado == 0): ?> En espera de aceptacion <?php endif; ?><?php if($e->reservado == 1): ?> <a href="">Pagar</a> <?php endif; ?><?php if($e->reservado == 2): ?> <p>Denegado</p> <?php endif; ?></td>
                        </tr>
                <?php endforeach;
                endif
